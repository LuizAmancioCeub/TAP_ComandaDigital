...
public record GerenteRegisterDTO(@NotBlank(message = "Nome do Gerente precisa ser preenchido")
								@Length(min = 3, max = 20,message = "Nome deve ter entre {min} e {max} caracteres")
								String nome, 
								@NotBlank(message = "Telefone do Gerente precisa ser preenchido") 
								@DigitsOnly(message = "CPF deve conter apenas números") 
								@Length(min = 11, max = 11, message = "Telefone inválido")
								String telefone, 
								@NotBlank(message = "CPF do Gerente precisa ser preenchido") 
								@DigitsOnly(message = "CPF deve conter apenas números") 
